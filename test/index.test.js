...
describe('model test', () => {
  ...
  it('should find documents', async () => {
    // normal find
    const resp = await broker.call('model.find', null, { schema });
  ...
  it('should count documents', async () => {
    // normal find
    const resp = await broker.call('model.count', null, { schema });
  ...
  it('should get', async () => {
    ...
    // null
    try {
      await broker.call('model.get', null, { schema });
  ...
  it('should acl', async () => {
    ...
    try {
      await broker.call('model.count', null, { schema, acl: true });
      assert.fail('should error');
    } catch(errs) {
